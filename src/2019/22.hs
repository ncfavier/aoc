...
main :: IO ()
main = do
    Just shuffle <- parseMaybe (parseLines technique) <$> getContents
    print $ foldMap (techniqueToLinear @10007) shuffle
          $@ 2019
    print $ 101741582076661 `stimes` foldMap (techniqueToLinear @119315717514047) shuffle
          $? 2020
